...
#key is case sensitive, if doesen't exist, get key error
print(phone)
...
phone = phonebook.get('Chris', 'key not found') #value u wanna find plus default value if not found 
print(phone)

phonebook.clear()
print(phonebook)
#clears out content of dictionary
...
print()
print('*****  start section 10 - using popitem method ********')
print()
